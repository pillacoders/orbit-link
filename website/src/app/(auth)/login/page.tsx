...
function LoginContent() {
  ...
  const { login, googleLogin, walletLogin } = useAuth();
        ...
        <form onSubmit={handleSubmit} className={styles.authForm}>
          ...
          <div>
            ...
            <div style={{ position: 'relative' }}>
              ...
              <input id="login-password" className="input" type="password" placeholder="Enter your password"
                value={password} onChange={(e) => setPassword(e.target.value)} required style={{ paddingLeft: 40 }} />
            </div>
          </div>

          <button type="submit" className={`btn-solid ${styles.submitBtn}`} disabled={loading} id="login-submit">
